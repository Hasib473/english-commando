            ...
            <div className="mx-auto max-w-md rounded-2xl border border-[#dce9f7] bg-white p-8 shadow-sm">
                ...
                <div className="mt-6">
                    ...
                    <button
                        ...
                        className="mt-4 w-full flex justify-center items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    >
